...
struct Coin: Identifiable, Codable {
    ...
    var dictionary: NSDictionary{
        ...
        let dict = NSDictionary(
            dictionary: [CodingKeys.id : id,
                         CodingKeys.symbol: symbol,
                         CodingKeys.name: name,
                         CodingKeys.image: image,
                         CodingKeys.currentPrice: currentPrice
                        ])
        return dict
    }
    
    static func coinModelFromDict(_ dict: NSDictionary) -> Coin?{
        guard let name = dict[CodingKeys.name] as? String,
              let symbol = dict[CodingKeys.symbol] as? String,
              let id = dict[CodingKeys.id] as? String,
              let image = dict[CodingKeys.image] as? String,
              let currPrice = dict[CodingKeys.currentPrice] as? Double else {return nil}
    ...
    func willHoldTrue(amount: Double) -> Coin{
